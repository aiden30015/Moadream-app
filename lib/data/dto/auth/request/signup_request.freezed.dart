...
mixin _$SignupRequest {
 ...
 String get email; String get password; String get name; String get phone; String get address; String get dateOfBirth;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,email,password,name,phone,address,dateOfBirth);

@override
String toString() {
  return 'SignupRequest(email: $email, password: $password, name: $name, phone: $phone, address: $address, dateOfBirth: $dateOfBirth)';
}
...
@useResult
$Res call({
 String email, String password, String name, String phone, String address, String dateOfBirth
});
...
/// Create a copy of SignupRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? name = null,Object? phone = null,Object? address = null,Object? dateOfBirth = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  String name,  String phone,  String address,  String dateOfBirth)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignupRequest() when $default != null:
return $default(_that.email,_that.password,_that.name,_that.phone,_that.address,_that.dateOfBirth);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  String name,  String phone,  String address,  String dateOfBirth)  $default,) {final _that = this;
switch (_that) {
case _SignupRequest():
return $default(_that.email,_that.password,_that.name,_that.phone,_that.address,_that.dateOfBirth);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  String name,  String phone,  String address,  String dateOfBirth)?  $default,) {final _that = this;
switch (_that) {
case _SignupRequest() when $default != null:
return $default(_that.email,_that.password,_that.name,_that.phone,_that.address,_that.dateOfBirth);case _:
  return null;
...
class _SignupRequest implements SignupRequest {
  const _SignupRequest({required this.email, required this.password, required this.name, required this.phone, required this.address, required this.dateOfBirth});
...
/// Create a copy of SignupRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? name = null,Object? phone = null,Object? address = null,Object? dateOfBirth = null,}) {
