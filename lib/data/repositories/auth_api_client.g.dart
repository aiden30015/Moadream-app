...
class _AuthApiClient implements AuthApiClient {
  ...
  @override
  Future<KakaoLoginResponse> kakaoLogin(String accessToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'accessToken': accessToken};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<KakaoLoginResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/auth/kakao/login',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late KakaoLoginResponse _value;
    try {
      _value = KakaoLoginResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
